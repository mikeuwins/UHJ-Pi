...
class PhonoControlGUI(tk.Tk):
    def __init__(self):
        ...
        input_box.grid(row=0, column=0, padx=(12,20), sticky="n")
        input_box.columnconfigure((0,1), weight=1)

        input_left_frame = ttk.Frame(input_box, width=70)
        input_left_frame.grid(row=0, column=0, padx=10, pady=(12,0))
        ...
        input_right_frame.grid(row=0, column=1, padx=10, pady=(12,0))
        ...
        output_left_frame.grid(row=0, column=0, padx=10, pady=(12,0))
        ...
        output_right_frame.grid(row=0, column=1, padx=10, pady=(12,0))
