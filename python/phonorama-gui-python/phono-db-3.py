...
class PhonoControlGUI(tk.Tk):
    ...
    def load_defaults(self):
        ...
        self.input_left_val.config(text=input_value_to_db(0))
        self.input_right_val.config(text=input_value_to_db(0))
        self.output_left_val.config(text=output_value_to_db(0))
        self.output_right_val.config(text=output_value_to_db(0))
