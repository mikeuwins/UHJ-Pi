...
class PhonoControlGUI(tk.Tk):
    def __init__(self):
        ...
        self.input_left_fader = ttk.Scale(input_left_frame, from_=127, to=0, orient="vertical", length=220)
        ...
        self.input_right_fader = ttk.Scale(input_right_frame, from_=127, to=0, orient="vertical", length=220)
        ...
        self.output_left_fader = ttk.Scale(output_left_frame, from_=145, to=0, orient="vertical", length=220)
        ...
        self.output_right_fader = ttk.Scale(output_right_frame, from_=145, to=0, orient="vertical", length=220)
