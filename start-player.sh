...
# Function to detect generic audio devices (copied from start-live.sh)
detect_generic_devices() {
    ...
    echo "✓ Using input: hw:$input_card ($input_name)"
    ...
    echo "✓ Using output: hw:$output_card ($output_name)"
