...
# UHJ-Pi Raspberry Pi Setup Script - ESI HDMI Version
...
step_header "STEP 3/24: Install X11 and Blackbox"
...
step_header "STEP 13/24: Clone UHJ-Pi repository and build phono-control CLI"
